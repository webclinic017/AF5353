...
# MVP
optv = sco.minimize(port_vol, weights, method='SLSQP', bounds=bnds, constraints=cons)
...
tvols = []
for tret in trets:
    res = sco.minimize(port_vol, weights, method='SLSQP', bounds=bnds, constraints=cons)
...
print(f'Capital Market Line is \nRp= {a} + {b.round(3)} * Vol', \
